...
Draw.loadPlugin(function (ui) {
    ...
    window.resKeys = Object.keys(window).filter(key => /mx/.test(key)).filter(key => {
        var obj = window[key];
