...
Draw.loadPlugin(function (ui) {
    ...
    resKeys = Object.keys(window).filter(key => /mx/.test(key)).filter(key => !(window[key] instanceof Function));

    res = res.map(key => window[key]);
