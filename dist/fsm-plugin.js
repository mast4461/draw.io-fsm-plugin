...
var runFsm = function (ui) {
    var cells = ui.editor.graph.model.cells;
    var candidates = cells.filter(cell => cell.hasOwnProperty('geometry'));
...
Draw.loadPlugin(function (ui) {
    ...
    // Adds action
    ui.actions.addAction('runFsmAction', runFsm.bind(null, ui));
