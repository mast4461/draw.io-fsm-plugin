...
var runFsm = function (ui) {
    var graph = getFsmGraph(ui);
};

var getFsmGraph = function (ui) {
    var cells = Object.values(ui.editor.graph.model.cells);
    candidates = cells.filter(cell => cell.hasOwnProperty('geometry'));
...
},{"./util":7,"_process":5,"buffer":1}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
