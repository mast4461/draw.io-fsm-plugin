...
var getFsmGraph = function (ui) {
    var cells = util.getObjectValues(ui.editor.graph.model.cells);
    candidates = cells.filter(cell => cell.geometry);
