...
window.getStuff = function (obj) {
    return Object.keys(obj).filter(key => {
        var obj = window[key];
        return !(obj instanceof Function && obj.length > 0);
    }).map(x => ({ key: x, val: obj[x] }));
};
